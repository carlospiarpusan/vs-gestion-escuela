...
export type PlatformSchoolOverview = {
  id: string;
  nombre: string;
...
export async function loadPlatformSchoolOverviews(db: Pick<Pool, "query">) {
  ...
  return result.rows.map<PlatformSchoolOverview>((row) => {
